...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			accesstokens.Table:      accesstokens.ValidColumn,
			authorizecodes.Table:    authorizecodes.ValidColumn,
			blacklistedjtis.Table:   blacklistedjtis.ValidColumn,
			clients.Table:           clients.ValidColumn,
			idsessions.Table:        idsessions.ValidColumn,
			issuerpublickeys.Table:  issuerpublickeys.ValidColumn,
